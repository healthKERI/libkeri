...
impl Saider {
    ...
    pub fn from_sad(
        ...
        if sad.is_empty() || !sad.contains_key(label) {
            return Err(KERIError::ValueError(
                format!("Missing label field={} in sad.", label)
            ));
        }
    ...
    pub fn _derive(
        ...
        sad_copy.insert(label.to_string(), SadValue::String(Self::DUMMY.to_string().repeat(fs as usize)));
    ...
    pub fn verify(
        ...
        self.verify_internal(sad, prefixed, versioned, kind_opt, label, ignore).unwrap_or_else(|_| false)
    }
    ...
    pub fn saidify(
        ...
        let ignore_slice: Option<&[&str]> = ignore_refs
            .as_ref()
            .map(|v| v.as_slice());
        ...
        if !sad.contains_key(&label) {
            return Err(KERIError::ValueError(
                format!("Missing id field labeled={} in sad.", label)
            ));
        }
...
mod tests {
    ...
    fn test_saider() -> Result<(), KERIError> {
        ...
        let (saider, sad) = match Saider::saidify(sad0.clone(), None, None, Some(label.to_string()), None) {
            Ok(result) => result,
            Err(e) => {
        ...
        sad0.insert(
            "type".to_string(),
            SadValue::String("object".to_string())
        );
        ...
        a_prop.insert(
            "type".to_string(),
            SadValue::String("string".to_string())
        );
        properties.insert(
            "a".to_string(),
            SadValue::Object(a_prop)
        );
        ...
        b_prop.insert(
            "type".to_string(),
            SadValue::String("number".to_string())
        );
        properties.insert(
            "b".to_string(),
            SadValue::Object(b_prop)
        );
        ...
        properties.insert(
            "c".to_string(),
            SadValue::Object(c_prop)
        );

        // Add properties to schema
        sad0.insert(
            "properties".to_string(),
            SadValue::Object(properties)
        );
        ...
        assert_eq!(saider.qb64(), "EMRvS7lGxc1eDleXBkvSHkFs8vUrslRcla6UXOJdcczw");
        let said0 = "EMRvS7lGxc1eDleXBkvSHkFs8vUrslRcla6UXOJdcczw";
        ...
        assert_eq!(saider.qb64(), "FFtf9ZYDSevUD5ySvqQ-bPHIpxRWIZxjfJ7ss_DHa3s4");
